...
<%
    try {
        ...
        String datCodigo = datos[0].replaceAll("\\{", "").replaceAll("\"", "").replaceAll(":", "").replace("bienId", "");
        ...
        File reportFile = new File(application.getRealPath("Reportes/ReporteMantenimientoPorBienesTable.jasper"));

        Map parameters = new HashMap();
        parameters.put("bienId", datCodigo);

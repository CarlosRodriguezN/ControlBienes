...
<%
    try {
        ...
        File f = new File(application.getRealPath("Reportes/ReporteMantenimientoGeneralTable.jasper"));
        int bit;
...
//        File f;
        ...
        jasperPrint = JasperFillManager.fillReport(f.getPath(), parameters, c.connectDatabase());
        String csvFileName = "informeDemo.csv";
...
// Ahora leemos el fichero y forzamos al navegador a que nos descargue el fichero.
        ...
        response.setContentType("application/csv; charset=utf-8"); //Tipo de fichero.
        response.setHeader("Content-Disposition", "attachment;filename=" + csvFileName + ""); //Configurar cabecera http
        response.setHeader("Content-type", "application/csv; charset="+Charset.forName("utf-8").displayName());

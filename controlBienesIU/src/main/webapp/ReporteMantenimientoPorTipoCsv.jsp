...
<html>
    ...
    <%
        ...
        Integer id = Integer.valueOf(nombre);
        ArrayList<Mantenimientos> listMantenimiento = new ArrayList<Mantenimientos>();
        if (UsuLinea != null) {
            if (session.getAttribute("ingreso").toString().equals("true")) {

                String serMantenimiento = sMantenimientoN.BuscarMantenimientoTipoFechas(id, fechai, fechaf);
    ...
    <script>
        ...
        function exportarACSV() {
            ...
            resp = exportToCsv("ReporteMantenimientoPorTipo.csv", arreglo)
        }
            ...
            <div class="row">
                <div class="widget widget-table">
                    <div class="widget-header">
                        <h3><i class="fa fa-table"></i> Mantenimientos Por Tipo.</h3> 
                    </div>

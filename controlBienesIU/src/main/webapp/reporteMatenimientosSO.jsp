...
<%
    try {
        ...
        String datNombres = datos[0].replaceAll("\\{", "").replaceAll("\"", "").replaceAll(":", "").replace("bienSO", "");
        ...
        File reportFile = new File(application.getRealPath("Reportes/ReporteMantenimientoSOTable.jasper"));
        System.out.println(datNombres);
        Map parameters = new HashMap();
        parameters.put("versionso", datNombres.toUpperCase());

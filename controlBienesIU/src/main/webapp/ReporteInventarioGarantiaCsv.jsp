...
<html>
    ...
    <%     
        ...
        String fechactual = fechaHora.format(date);

        ArrayList<Bien> listBien = new ArrayList<Bien>();
        if (UsuLinea != null) {
            if (session.getAttribute("ingreso").toString().equals("true")) {
                String serBien = sBien.listaGarantiaPorFecha(fechactual);
    ...
    <script>
        ...
        function exportarACSV() {
            ...
            resp = exportToCsv("ReporteInventarioGarantia.csv", arreglo)
        }

...
<html>
    ...
    <%     
        ...
        if (UsuLinea != null) {
            if (session.getAttribute("ingreso").toString().equals("true")) {
                String serTraspaso = sTraspaso.listaTaspasoMarcaPorFecha(marca, fechai, fechaf);
    ...
    <script>
        ...
        function exportarACSV() {
            ...
            resp = exportToCsv("ReporteInventarioMarca.csv", arreglo)
        }
//Asignamos una manejador del evento click al botón html:
    ...
    <div class="main-header">
        <h2>Bienes</h2>
        <em>Bienes por Marca registrados en el sistema.</em>
    </div>
            ...
            <div class="row">
                <div class="widget widget-table">
                    <div class="widget-header">
                        <h3><i class="fa fa-table"></i> Marca de Bienes.</h3> 
                    </div>
                            ...
                            <table id="tablacsv" class="table table-sorting table-hover table-bordered">
                                ...
                                <tbody>
                                    <%for (Traspaso oPet : listTraspaso) {
                                            ...
                                            out.println("<td>" + oPet.getBnCodBien().getBnEstadoUso() + "</td>");

...
<html>
    ...
    <div class="main-header">
        <h2>Administrador del sistema de Talento Humano</h2>
    ...
    <div class="main-content">
        <div class="well well-lg knowledge-recent-popular">
            <div class="row">
                ...
                <form role="form" id="FrmEditRolAdmin">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input value="<%= objPerio.getIntrolId().getStrnombre().replace("DE ", "") %>" required="true" type="text" class="form-control" id="TipoFlDesc" name="TipoFlDesc" placeholder="Ingrese la descripción" readonly="true">
                    </div>
                ...
                <div class="col-sm-12" align='right'>
                    <button  type='button' class='btn btn-danger' onclick="clicMosAdmins()">Cancelar</button>
                    <button  type='button' class='btn btn-primary' onclick="EditAdministrador(<%= objPerio.getIntid()%>)">Editar</button>
                </div>
            </div>
        </div>

...
<html>
    ...
    <%     
        ...
        if (UsuLinea != null) {
            if (session.getAttribute("ingreso").toString().equals("true")) {
                String serBien = sBien.listaBienDesactivadosPorFecha(fechai, fechaf);
                String resultadoBien = "{\"respuesta\":" + serBien + "}";
    ...
    <script>
        ...
        function exportarACSV() {
            ...
            resp = exportToCsv("ReporteInventarioDesactivados.csv", arreglo)
        }
//Asignamos una manejador del evento click al botón html:
    ...
    <div class="main-header">
        <h2>Bienes</h2>
        <em> Bienes Desactivados registrados en el sistema.</em>
    </div>
            ...
            <div class="row">
                ...
                <div class="widget widget-table">
                    <div class="widget-header">
                        <h3><i class="fa fa-table"></i> Bienes Desactivados.</h3> 
                    </div>
                            ...
                            <table id="tablacsv" class="table table-sorting table-hover table-bordered">
                                ...
                                <tbody>
                                    <%for (Bien oPet : listBien) {
                                            ...
                                            out.println("<td>" + oPet.getBnSerie() + "</td>");
                                            ...
                                            out.println("<td>" + oPet.getDpId().getDpDescripcion() + "</td>");
                                                ...
                                                JSONObject reqMotivoinforme = new JSONObject(sMotivoInforme.listaMotivoinformeId(oPet.getBnCodMotBaja()));
                                                objMotivoinforme = new Gson().fromJson(reqMotivoinforme.toString(), Motivoinforme.class);
                            
                                            out.println("<td>" + objMotivoinforme.getMotDetalle() + "</td>");

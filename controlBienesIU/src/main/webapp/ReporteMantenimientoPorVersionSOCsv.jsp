...
<html>
    ...
    <%
        ...
        ArrayList<Bien> listMantenimiento = new ArrayList<Bien>();
        ArrayList<Traspaso> listTraspaso = new ArrayList<Traspaso>();
        if (UsuLinea != null) {
            if (session.getAttribute("ingreso").toString().equals("true")) {

                String serMantenimiento = sMantenimientoN.BuscarMantenimientoVersionSoFechas(nombre, fechai, fechaf);
    ...
    <script>
        ...
        function exportarACSV() {
            ...
            resp = exportToCsv("ReportePorVersionSO.csv", arreglo)
        }

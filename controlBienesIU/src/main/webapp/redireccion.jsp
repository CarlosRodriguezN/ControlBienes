...
<html>
    <head>
        ...
        <link href="js/css/bird.css" rel="stylesheet" type="text/css"/>
        
        <link href="assets/css/skins/darkblue.css" rel="stylesheet" type="text/css"/>


        <script type="text/javascript">
            var timeLimit = 9; //tiempo en minutos 9
            ...
            <div class="col-sm-12" align="center">
                <div class="inner-page">
                    ...
                    <div align="center">
                        ...
                        <h1>SESIÓN POR CADUCAR</h1><br/>
                        <p>Su sesion esta a punto de expirar por favor vuelva a la pagina de <a style='color: #00417F;cursor: pointer' href="index.jsp"> <b>inicio</b></a> para continuar, o a su vez puede <a style='color: #00417F;cursor: pointer' onclick="Matar();"> <b>cerrar su sesion ahora</b></a></p>
                        <p>El tiempo de inactividad máximo es de 20 minutos, por lo cúal se procedera al cierre de su sesión.</p>

...
<html>
    ...
    <script>
        ...
        function exportarACSV() {
            ...
            resp = exportToCsv("ReporteInventarioAudiTaspaso.csv", arreglo)
        }
//Asignamos una manejador del evento click al botón html:
    ...
    <div class="main-header">
        <h2>Auditorias</h2>
        <em> Auditorias de Traspasos registrados en el sistema.</em>
    </div>
            ...
            <div class="row">
                ...
                <div class="widget widget-table">
                    <div class="widget-header">
                        <h3><i class="fa fa-table"></i> Auditorias de Traspasos.</h3> 
                    </div>

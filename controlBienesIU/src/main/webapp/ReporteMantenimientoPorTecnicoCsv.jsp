...
<html>
    ...
    <%
        ...
        if (UsuLinea != null) {
            if (session.getAttribute("ingreso").toString().equals("true")) {
                ...
                String serMantenimiento = sMantenimientoN.BuscarMantenimientoTecnicoFechas(nombre, fechai, fechaf);
    ...
    <script>
        ...
        function exportarACSV() {
            ...
            resp = exportToCsv("ReporteMantenimientoPorTécnico.csv", arreglo)
        }
            ...
            <div class="row">
                <div class="widget widget-table">
                    <div class="widget-header">
                        <h3><i class="fa fa-table"></i> Mantenimientos Por Técnico.</h3> 
                    </div>
